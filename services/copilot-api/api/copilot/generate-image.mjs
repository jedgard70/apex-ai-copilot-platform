...
export default async function handler(req, res) {
  ...
  if (!falKey) {
    return sendJson(res, 200, {
      ...
      message: 'No image provider configured. Add FAL_KEY to your Vercel environment variables to enable real ArchVis image generation.',
    })
  }
  ...
  try {
    ...
    return sendJson(res, 200, {
      providerStatus: 'not-configured',
      message: 'No image provider configured. Add FAL_KEY to Vercel environment variables.',
    })
  } catch (error) {
