...
import { ContractsPermitsPanel } from '../../../../packages/modules/legal/frontend/ContractsPermitsPanel'
import { ResearchPanel } from './ResearchPanel'
import { CrmPipelinePanel } from '../../../../packages/modules/crm/frontend/CrmPipelinePanel'
import { FinancePanel } from '../../../../packages/modules/finance/frontend/FinancePanel'
import { AiControlPanel } from './AiControlPanel'
import { CodeEditorPanel } from './CodeEditorPanel'
import VisasCitizenshipPanel from '../../../../packages/modules/legal/frontend/VisasCitizenshipPanel'
import { LegalGeneralPanel } from '../../../../packages/modules/legal/frontend/LegalGeneralPanel'
...
import { PromptsCatalogPanel } from './PromptsCatalogPanel'
import { OwnerConsolePanel } from './OwnerConsolePanel'
import { FinanceDeskPanel } from './FinanceDeskPanel'
import { MarketCrmPanel } from './MarketCrmPanel'
...
export function MainPanelsRouter(props: MainPanelsRouterProps) {
  switch (props.panelView) {
    ...
    case 'dashboard':
    case 'owner':
      return <OwnerConsolePanel />
    case 'finance':
      return <FinanceDeskPanel />
    case 'crm':
      return <MarketCrmPanel />
    case 'ia-integrations':
      return <IaIntegrationsPanel />
    case 'service-catalog':
      return <ServiceCatalogPanel />
    case 'prompt-catalog':
      return <PromptsCatalogPanel />
    case 'code-editor': {
      const isOwner = props.currentRole === 'owner' || props.currentRole === 'owner_admin'
