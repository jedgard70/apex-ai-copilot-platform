...
import LegalStudioPanel from './components/LegalStudioPanel'
...
import { CrmPanel } from '../../../packages/modules/crm/frontend/CrmPanel'
...
import { AccountingPanel } from '../../../packages/modules/accounting/frontend/AccountingPanel'
...
import { AccountsPortal } from '../../../packages/modules/accounting/frontend/AccountsPortal'
...
function RootApp() {
  ...
  if (showLandingPage) {
    return (
      <>
        <VslLandingPage onEnterApp={() => setShowLandingPage(false)} />
        <Analytics />
        <SpeedInsights />
      </>
    );
