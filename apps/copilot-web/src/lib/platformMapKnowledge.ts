  ...
  return [
    {
      ...
      features: [
        ...
        { name: 'Platform Status / Provider Keys', status: 'ready', command: 'status das keys', summary: 'Verifica em tempo real o saldo e status de cada provedor pago (fal.ai, Veo, ElevenLabs, Stripe, Brave Search, etc). Abre na aba "Status das Keys" do Platform Map.', outputs: ['status por provedor', 'saldo', 'link para recarregar'] },
