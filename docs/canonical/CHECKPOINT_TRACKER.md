...
-   [ 2 0 2 6 - 0 7 - 1 3 ]   S a n e a m e n t o   T o t a l   c o n c l u i d o :   C h a v e s   e x p u r g a d a s ,   r e p o   l i m p o ,   b o t s   e x t e r n o s   b l o q u e a d o s ,   C I   e s t a b i l i z a d o .  
 
### Checkpoint 167 (2026-07-17)
- **TEMA E (Automação de Marketing e Vendas)**: Concluída a integração com a Meta Graph API.
  - Implementado SQL (\ 014_social_marketing.sql\) com suporte a campanhas (Construtora / eBook) e status de aprovação.
...
- **BIM 3D Studio (M7)**: Refinamento completo da interface 3D com React Three Fiber (@react-three/fiber).
  - Integrada ilumina��o realista, sombras e controles orbitais.
  ...
  - Adicionada altern�ncia de visibilidade por disciplina (Arquitetura, Estrutura e MEP).
  - Valida��o de build tsc/vite verde e testes 100% aprovados.
