...
create policy tenants_owner_admin_write
...
create policy tenant_members_owner_admin_write
...
create policy projects_insert_tenant_staff
...
create policy projects_update_assigned_staff
...
create policy project_members_select_assigned
