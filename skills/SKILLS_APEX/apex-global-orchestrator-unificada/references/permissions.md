...
- Engineering: projects, BIM, documents, agents, technical deliveries.
- Commercial: leads, opportunities, proposals, clients, campaigns.
- Finance: revenue, billing, contracts, payment status.
- Marketing: campaigns, products, landing pages, content.
- Documentation/Legal: contracts, proposals, compliance docs.
- Client: own projects, own proposals, own documents, own deliveries.
- Partner: delegated projects and tasks only.
