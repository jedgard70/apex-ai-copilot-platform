...
const outputPath = "D:/AI Jedgard/outputs/produtos_ebook/planilha_controle_de_obra_premium.xlsx";
const logoPath = "D:/ebook/Ebook Guia Imoveis/pagina ebook gemini/jedgard-e.png";
...
resumo.getRange("A2:H2").values = [["Produto complementar | Seu Imovel Sem Arrependimento | Dr. Jose Edgard de Oliveira"]];
...
resumo.images.add({
  dataUrl: logoData,
  anchor: { from: { row: 0, col: 0 }, extent: { widthPx: 112, heightPx: 40 } },
});
resumo.images.add({
  dataUrl: coverData,
