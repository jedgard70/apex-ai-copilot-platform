...
const SECTIONS: ManualSection[] = [
  ...
  {
    id: 'accounting',
    title: '📒 Contabilidade CRC',
    icon: '🧾',
    summary: 'Apoio contábil com DRE, IRPJ, livro diário e obrigações fiscais.',
    items: [
      {
        name: 'Relatórios Contábeis',
        description: 'Gera DRE, balanço, IRPJ estimado, livro diário. Campos para assinatura CRC.',
        howToUse: 'Peça: "gere um DRE", "calcular IRPJ", "abrir contabilidade".',
        example: '"demonstrativo de resultados do trimestre"',
        availableTo: 'todos',
      },
    ],
  },
