...
const APEX_RUNTIME_COMMANDS = [
  ...
  'set APEX_API_URL=http://127.0.0.1:8888',
]
...
export function ModelTrainingPage() {
  ...
  const steps = [
    ...
    {
      icon: 'computer',
      title: '4. Rodar Apex Own Runtime',
      body: 'Baixe ou publique o pacote do motor Apex e suba a API própria. Ela serve o Apex Desktop (.exe), o site e os apps de celular sem depender do provedor de chat externo.',
      done: false,
    },
    {
      icon: 'check_circle',
      title: '5. Aparece no seletor de modelos',
      body: 'O modelo "Apex AI 2.0 (Motor Principal)" já está no seletor. Aponte APEX_API_URL ou APEX_OWN_ENGINE_URL para a API própria da Apex.',
      done: true,
    },
  ]
        ...
        <div className="max-w-5xl mx-auto space-y-8">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-[#c6c6ce] leading-relaxed">
                  ...
                  (desktop, site e apps) via Apex Own Runtime —{' '}
          ...
          <div className="grid grid-cols-3 gap-6">
            {[
              ...
              { label: 'FORMATO DE EXPORTAÇÃO', value: 'GGUF', accent: false, sub: 'Apex Own Runtime' },
            ].map((stat, i) => (
              <div
                key={i}
                className="p-6 rounded-2xl"
